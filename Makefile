...
block_mult.s: generate_assembly.py
	$(PYTHON) generate_assembly.py

host_block_mult.o: block_mult.s
	$(HOST_CC) block_mult.s $(COMMON_CFALGS) $(HOST_GCC_CFLAGS) -c -o $@
...
inner_docker_main: inner_docker_main.o inner_docker_matrix.o docker_block_mult.o
...
inner_docker_tests: inner_docker_matrix.o inner_docker_unit_tests.o docker_block_mult.o block_test_value block_add_test_value matrix_test_value matrix_transpose_value
